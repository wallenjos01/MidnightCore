...
public class ClientInit implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        FabricLoader.getInstance().getEntrypoints(Constants.DEFAULT_NAMESPACE + "_client", ClientModInitializer.class).forEach(ClientModInitializer::onInitializeClient);
