...
public class FabricInventoryGUI extends MInventoryGUI {
    ...
    private static void onClick(ContainerClickEvent event) {
        ...
        MInventoryGUI gui = openGuis.get(player);
        if(gui == null) {
            return;
        }
    ...
    public static void registerEvents(Object owner) {
        ...
        Event.register(MenuCloseEvent.class, owner, FabricInventoryGUI::onClose);
