...
public class Adapter_v1_9_R1 implements SpigotAdapter {

    private SkinUpdater_v1_9_R1 updater;

    private Field handle;
    public net.minecraft.server.v1_9_R1.ItemStack getHandle(org.bukkit.inventory.ItemStack is) {
    ...
    public boolean init() {
        ...
        updater = new SkinUpdater_v1_9_R1();
        return updater.init();
    }
