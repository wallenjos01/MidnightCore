...
public class Adapter_v1_10_R1 implements SpigotAdapter {

    private SkinUpdater_v1_10_R1 updater;

    private Field handle;
    public net.minecraft.server.v1_10_R1.ItemStack getHandle(org.bukkit.inventory.ItemStack is) {

        try {
            return (net.minecraft.server.v1_10_R1.ItemStack) handle.get(is);
    ...
    public boolean init() {
        ...
        updater = new SkinUpdater_v1_10_R1();
        return updater.init();
    }
    ...
    public void sendMessage(Player pl, MComponent comp) {
        ...
        EntityPlayer epl = ((CraftPlayer) pl).getHandle();
        epl.playerConnection.sendPacket(new PacketPlayOutChat(IChatBaseComponent.ChatSerializer.a(toJsonString(comp)), (byte) 1));
    }
    ...
    public void sendActionBar(Player pl, MComponent comp) {
        ...
        EntityPlayer epl = ((CraftPlayer) pl).getHandle();
        epl.playerConnection.sendPacket(new PacketPlayOutChat(IChatBaseComponent.ChatSerializer.a(toJsonString(comp)), (byte) 2));
    }
    ...
    public void setTag(ItemStack is, ConfigSection sec) {
        ...
        net.minecraft.server.v1_10_R1.ItemStack mis = getHandle(is);
