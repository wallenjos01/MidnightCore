package org.wallentines.mcore.adapter.v1_14_R1;
...
public class AdapterImpl implements Adapter {
    ...
    private ItemReflector<net.minecraft.server.v1_14_R1.ItemStack, CraftItemStack> reflector;
    ...
    public void runOnServer(Runnable runnable) {
        ...
        server.getHandle().getServer().e(runnable);
    }
    ...
    public ItemStack buildItem(Identifier id, int count, byte data) {
        net.minecraft.server.v1_14_R1.ItemStack is = new net.minecraft.server.v1_14_R1.ItemStack(IRegistry.ITEM.get(new MinecraftKey(id.toString())), count);
    ...
    public String getTranslationKey(ItemStack is) {
        net.minecraft.server.v1_14_R1.ItemStack mis = reflector.getHandle(is);
    ...
    public ConfigSection getTag(ItemStack itemStack) {
        ...
        net.minecraft.server.v1_14_R1.ItemStack mis = reflector.getHandle(itemStack);
    ...
    public GameVersion getGameVersion() {
        return new GameVersion(SharedConstants.a().getId(), SharedConstants.a().getProtocolVersion());
    }
