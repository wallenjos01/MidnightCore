...
public class AdapterImpl implements Adapter {
    ...
    public void loadTag(Player player, ConfigSection configSection) {
        ...
        for (Object mobeffect : epl.getEffects()) {
            epl.playerConnection.sendPacket(new PacketPlayOutEntityEffect(epl.getId(), (MobEffect) mobeffect));
        }
    }
    ...
    private IChatBaseComponent convert(Component component) {
        return ChatSerializer.a(component.toJSONString(getGameVersion()));
    }
}
