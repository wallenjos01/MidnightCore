...
public class AdapterImpl implements Adapter {
    ...
    public net.minecraft.server.v1_13_R1.ItemStack getHandle(ItemStack is) {

        try {
            return (net.minecraft.server.v1_13_R1.ItemStack) handle.get(is);
    ...
    public ConfigSection getTag(ItemStack itemStack) {
        ...
        net.minecraft.server.v1_13_R1.ItemStack mis = getHandle(itemStack);
