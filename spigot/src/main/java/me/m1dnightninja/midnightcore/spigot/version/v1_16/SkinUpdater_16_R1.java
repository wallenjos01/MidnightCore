...
public class SkinUpdater_16_R1 implements ISkinUpdater {
    ...
    public boolean initialize() {
        ...
        try {
            ...
            getTypeKey = ReflectionUtil.getMethod(world, "getTypeKey");
            ...
            respawnConstructor = ReflectionUtil.getConstructor(packetPlayOutRespawn, resourceKey, resourceKey, long.class, enumGameMode, enumGameMode, boolean.class, boolean.class, boolean.class);
    ...
    public void updatePlayer(Player player, Skin skin, Collection<? extends Player> observers) {
        ...
        if (observers.contains(player)) {
            ...
            Object respawn = ReflectionUtil.construct(respawnConstructor,
                    ReflectionUtil.callMethod(world, getTypeKey, false),
