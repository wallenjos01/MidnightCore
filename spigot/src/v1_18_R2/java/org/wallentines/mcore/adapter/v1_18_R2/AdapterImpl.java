...
public class AdapterImpl implements Adapter {
    ...
    public boolean initialize() {
        ...
        try {
            ...
            obReflector = new Reflector<>(Objective.class, "org.bukkit.craftbukkit.v1_18_R2.scoreboard.CraftObjective", "objective");
            teamReflector = new Reflector<>(Team.class, "org.bukkit.craftbukkit.v1_18_R2.scoreboard.CraftTeam", "team");
    ...
    public void loadTag(Player player, ConfigSection configSection) {
        ...
        epl.c.ac().e(epl);
        for (MobEffect mobeffect : epl.dX()) {
    ...
    public ItemStack buildItem(Identifier id, int count, byte data) {
        net.minecraft.world.item.ItemStack is = new net.minecraft.world.item.ItemStack(IRegistry.X.a(MinecraftKey.a(id.toString())), count);
        return CraftItemStack.asCraftMirror(is);
    }

    @Override
    public Identifier getItemId(ItemStack is) {
        return Identifier.parse(Objects.requireNonNull(IRegistry.X.b(reflector.getHandle(is).c())).toString());
    }
    ...
    public Color getRarityColor(ItemStack itemStack) {
        Integer clr = reflector.getHandle(itemStack).A().e.e();
