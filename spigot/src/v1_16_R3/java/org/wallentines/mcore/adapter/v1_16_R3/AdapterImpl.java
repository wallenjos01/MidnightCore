...
public class AdapterImpl implements Adapter {
    ...
    public boolean initialize() {
        ...
        try {
            ...
            obReflector = new Reflector<>(Objective.class, "org.bukkit.craftbukkit.v1_16_R3.scoreboard.CraftObjective", "objective");
            teamReflector = new Reflector<>(Team.class, "org.bukkit.craftbukkit.v1_16_R3.scoreboard.CraftTeam", "team");
    ...
    public ItemStack buildItem(Identifier id, int count, byte data) {
        net.minecraft.server.v1_16_R3.ItemStack is = new net.minecraft.server.v1_16_R3.ItemStack(IRegistry.ITEM.get(new MinecraftKey(id.toString())), count);
    ...
    public String getTranslationKey(ItemStack is) {
        net.minecraft.server.v1_16_R3.ItemStack mis = reflector.getHandle(is);
    ...
    public ConfigSection getTag(ItemStack itemStack) {
        ...
        net.minecraft.server.v1_16_R3.ItemStack mis = reflector.getHandle(itemStack);
