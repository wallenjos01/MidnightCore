...
public class AdapterImpl implements Adapter {
    ...
    private ItemReflector<net.minecraft.server.v1_15_R1.ItemStack, CraftItemStack> reflector;
    ...
    public String getTranslationKey(ItemStack is) {
        net.minecraft.server.v1_15_R1.ItemStack mis = reflector.getHandle(is);
    ...
    public ConfigSection getTag(ItemStack itemStack) {
        ...
        net.minecraft.server.v1_15_R1.ItemStack mis = reflector.getHandle(itemStack);
