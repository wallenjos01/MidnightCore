...
public class AdapterImpl implements Adapter {
    ...
    public boolean initialize() {
        ...
        try {
            ...
            obReflector = new Reflector<>(Objective.class, "org.bukkit.craftbukkit.v1_20_R1.scoreboard.CraftObjective", "objective");
            teamReflector = new Reflector<>(Team.class, "org.bukkit.craftbukkit.v1_20_R1.scoreboard.CraftTeam", "team");
    ...
    public void loadTag(Player player, ConfigSection configSection) {
        ...
        epl.d.ac().e(epl);
        for (MobEffect mobeffect : epl.eo()) {
            epl.c.a(new PacketPlayOutEntityEffect(epl.af(), mobeffect));
        }
    }
    ...
    public Identifier getItemId(ItemStack is) {
        return Identifier.parse(Objects.requireNonNull(BuiltInRegistries.i.b(reflector.getHandle(is).d())).toString());
    }
