...
public class AdapterImpl implements Adapter {
    ...
    public boolean initialize() {
        ...
        try {
            ...
            obReflector = new Reflector<>(Objective.class, "org.bukkit.craftbukkit.v1_20_R3.scoreboard.CraftObjective", "objective");
            teamReflector = new Reflector<>(Team.class, "org.bukkit.craftbukkit.v1_20_R3.scoreboard.CraftTeam", "team");
    ...
    public void loadTag(Player player, ConfigSection configSection) {
        ...
        epl.d.ae().e(epl);
        for (MobEffect mobeffect : epl.es()) {
            epl.c.a(new PacketPlayOutEntityEffect(epl.aj(), mobeffect));
        }
    }
