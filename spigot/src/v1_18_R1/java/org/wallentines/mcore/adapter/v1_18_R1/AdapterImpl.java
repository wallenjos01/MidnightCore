...
public class AdapterImpl implements Adapter {
    ...
    public boolean initialize() {
        ...
        try {
            ...
            obReflector = new Reflector<>(Objective.class, "org.bukkit.craftbukkit.v1_18_R1.scoreboard.CraftObjective", "objective");
            teamReflector = new Reflector<>(Team.class, "org.bukkit.craftbukkit.v1_18_R1.scoreboard.CraftTeam", "team");
    ...
    public void loadTag(Player player, ConfigSection configSection) {
        ...
        epl.c.ac().e(epl);
        for (MobEffect mobeffect : epl.dW()) {
