...
public class AdapterImpl implements Adapter {
    ...
    public boolean initialize() {
        ...
        try {
            ...
            obReflector = new Reflector<>(Objective.class, "org.bukkit.craftbukkit.v1_20_R2.scoreboard.CraftObjective", "objective");
            teamReflector = new Reflector<>(Team.class, "org.bukkit.craftbukkit.v1_20_R2.scoreboard.CraftTeam", "team");
