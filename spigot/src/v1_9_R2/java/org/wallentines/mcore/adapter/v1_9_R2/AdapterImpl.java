package org.wallentines.mcore.adapter.v1_9_R2;
...
public class AdapterImpl implements Adapter {
    ...
    public net.minecraft.server.v1_9_R2.ItemStack getHandle(ItemStack is) {
    ...
    public ItemStack buildItem(Identifier id, int count, byte data) {
        net.minecraft.server.v1_9_R2.ItemStack is = new net.minecraft.server.v1_9_R2.ItemStack(Item.REGISTRY.get(new MinecraftKey(id.toString())), count, data);
    ...
    public ConfigSection getTag(ItemStack itemStack) {
        ...
        net.minecraft.server.v1_9_R2.ItemStack mis = getHandle(itemStack);
    ...
    public GameVersion getGameVersion() {
        ...
        return new UncertainGameVersion<>(server.getVersion(), 110,
