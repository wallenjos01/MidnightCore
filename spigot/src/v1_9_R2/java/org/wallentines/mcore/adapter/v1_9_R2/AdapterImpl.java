...
public class AdapterImpl implements Adapter {
    ...
    private ItemReflector<net.minecraft.server.v1_9_R2.ItemStack, CraftItemStack> reflector;
    ...
    public ConfigSection getTag(ItemStack itemStack) {
        ...
        net.minecraft.server.v1_9_R2.ItemStack mis = reflector.getHandle(itemStack);
