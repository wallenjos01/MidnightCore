package org.wallentines.mcore.adapter.v1_9_R1;
...
public class AdapterImpl implements Adapter {
    ...
    public net.minecraft.server.v1_9_R1.ItemStack getHandle(ItemStack is) {

        try {
            return (net.minecraft.server.v1_9_R1.ItemStack) handle.get(is);
    ...
    public ItemStack buildItem(Identifier id, int count, byte data) {
        net.minecraft.server.v1_9_R1.ItemStack is = new net.minecraft.server.v1_9_R1.ItemStack(Item.REGISTRY.get(new MinecraftKey(id.toString())), count, data);
        return CraftItemStack.asCraftMirror(is);
    }

    @Override
    public Identifier getItemId(ItemStack is) {
        return Identifier.parse(Item.REGISTRY.b(getHandle(is).getItem()).toString());
    }
    ...
    public String getTranslationKey(ItemStack is) {
        net.minecraft.server.v1_9_R1.ItemStack mis = getHandle(is);
    ...
    public ConfigSection getTag(ItemStack itemStack) {
        ...
        net.minecraft.server.v1_9_R1.ItemStack mis = getHandle(itemStack);
    ...
    public GameVersion getGameVersion() {
        ...
        return new UncertainGameVersion<>(server.getVersion(), 107,
