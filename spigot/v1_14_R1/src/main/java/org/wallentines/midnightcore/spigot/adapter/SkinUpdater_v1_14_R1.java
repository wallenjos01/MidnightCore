...
public class SkinUpdater_v1_14_R1 implements SkinUpdater {
    ...
    public void updateSkin(Player spl, Skin skin) {
        ...
        PacketPlayOutRespawn respawn = new PacketPlayOutRespawn(epl.dimension, world.getWorldData().getType(), epl.playerInteractManager.getGameMode());
