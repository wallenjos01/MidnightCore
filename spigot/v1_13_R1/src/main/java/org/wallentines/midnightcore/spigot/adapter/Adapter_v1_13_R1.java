...
public class Adapter_v1_13_R1 implements SpigotAdapter {
    ...
    public net.minecraft.server.v1_13_R1.ItemStack getHandle(org.bukkit.inventory.ItemStack is) {

        try {
            return (net.minecraft.server.v1_13_R1.ItemStack) f_handle.get(is);
    ...
    public boolean init() {
        ...
        updater = new SkinUpdater_v1_13_R1();
        return updater.init();
    }
    ...
    public void setTag(ItemStack is, ConfigSection sec) {
        ...
        net.minecraft.server.v1_13_R1.ItemStack mis = getHandle(is);
    ...
    public ConfigSection getTag(ItemStack is) {
        ...
        return JsonConfigProvider.INSTANCE.loadFromString(cmp.b_());
    }
    ...
    public ConfigSection getTag(Player pl) {
        ...
        return JsonConfigProvider.INSTANCE.loadFromString(tag.b_());
    }
