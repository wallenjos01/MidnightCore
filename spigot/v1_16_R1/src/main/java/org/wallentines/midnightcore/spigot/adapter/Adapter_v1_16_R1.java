...
public class Adapter_v1_16_R1 implements SpigotAdapter {

    private SkinUpdater_v1_16_R1 updater;

    private Field handle;

    public net.minecraft.server.v1_16_R1.ItemStack getHandle(org.bukkit.inventory.ItemStack is) {

        try {
            return (net.minecraft.server.v1_16_R1.ItemStack) handle.get(is);
    ...
    public boolean init() {
        ...
        updater = new SkinUpdater_v1_16_R1();
        return updater.init();
    }
    ...
    public void sendMessage(Player pl, MComponent comp) {
        ...
        epl.a(IChatBaseComponent.ChatSerializer.a(comp.toString()), ChatMessageType.SYSTEM, NIL_UUID);
    ...
    public void sendActionBar(Player pl, MComponent comp) {
        ...
        EntityPlayer epl = ((CraftPlayer) pl).getHandle();
        epl.a(IChatBaseComponent.ChatSerializer.a(comp.toString()), ChatMessageType.GAME_INFO, NIL_UUID);
    ...
    public void setTag(ItemStack is, ConfigSection sec) {
        ...
        net.minecraft.server.v1_16_R1.ItemStack mis = getHandle(is);
