...
public class SkinUpdater_v1_18_R1 implements SkinUpdater {
    ...
    public void updateSkin(Player spl, Skin skin) {
        ...
        PacketPlayOutRespawn respawn = new PacketPlayOutRespawn(
                world.q_(),
                world.aa(),
                BiomeManager.a(spl.getWorld().getSeed()),
                epl.d.b(),
                epl.d.c(),
                world.ad(),
                world.D(),
        ...
        PacketPlayOutAbilities abilities = new PacketPlayOutAbilities(epl.fr());
    ...
    private void applyActiveProfile(PacketPlayOutPlayerInfo packet, Skin skin) {
        ...
        profile.getProperties().putAll(epl.fp().getProperties());
