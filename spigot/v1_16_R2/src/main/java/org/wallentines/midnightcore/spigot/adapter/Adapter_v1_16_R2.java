...
public class Adapter_v1_16_R2 implements SpigotAdapter {

    private SkinUpdater_v1_16_R2 updater;

    private Field handle;

    public net.minecraft.server.v1_16_R2.ItemStack getHandle(org.bukkit.inventory.ItemStack is) {
    ...
    public boolean init() {
        ...
        updater = new SkinUpdater_v1_16_R2();
        return updater.init();
    }
    ...
    public void setTag(ItemStack is, ConfigSection sec) {
        ...
        net.minecraft.server.v1_16_R2.ItemStack mis = getHandle(is);
