...
import me.m1dnightninja.midnightcore.common.inventory.PseudoItemStack;
import me.m1dnightninja.midnightcore.velocity.event.MidnightCoreInitializeEvent;
import me.m1dnightninja.midnightcore.velocity.module.lang.LangModule;
...
public class MidnightCore {
    ...
    public void onInitialize(ProxyInitializeEvent event) {
        ...
        MidnightCoreAPI api = new MidnightCoreImpl(new VelocityPlayerManager(), PseudoItemStack::new, dataFolder.toFile(), new PlayerDataModule(), new LastJoinedModule(), new PluginMessageModule(), new LangModule()) {
        ...
        server.getEventManager().fire(new MidnightCoreInitializeEvent(this, api));
